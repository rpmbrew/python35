...
# following order:
#
# 1) python35 with_rewheel 0
# 2) python35-setuptools build_rewheel 0
# 3) python35-pip build_rewheel 0
# 4) python35-wheel
# 5) python35-setuptools build_rewheel 1
# 6) python35-pip build_rewheel 1
# 7) python35 with_rewheel 1
...
#  __python35, python35_sitelib, python35_sitearch
...
- Modify macros to be specific to python35
